...
public sealed class ParadoxWorkspacePlaysetStore
{
    ...
    public ParadoxWorkspacePlaysetStore(string workspaceDirectory)
    {
    ...
    public static string GetPosdacaRootDirectory()
    {
        return Path.Combine(
    ...
    public static string GetWorkspaceDirectory(ParadoxGameDefinition game)
    {
        ArgumentNullException.ThrowIfNull(game);
        return Path.Combine(GetPosdacaRootDirectory(), game.WorkspaceFolderName);
    }

    public static ParadoxWorkspacePlaysetStore CreateForGame(ParadoxGameDefinition game)
    {
    ...
    public void SaveModIndex(IEnumerable<ModEntry> mods)
    {
        ...
        var index = new ParadoxWorkspaceModIndex(
            "1.0",
            ...
            mods
                ...
                .Select(mod => new ParadoxWorkspaceModIndexEntry(
                    ParadoxModIdentity.GetStableId(mod),
                    mod.Id,
                    mod.Title,
                    ...
                    mod.ContentPath,
                    mod.Version,
                    ParadoxModIdentity.GetIdentityKeys(mod)))
                .ToList());
