...
public static class ParadoxGameCatalog
{
    ...
    [
        ...
        new()
        {
            ...
            LinuxExecutableFileNames = ["binaries/ck3"],
            SteamAppId = "1158310",
        ...
        new()
        {
            ...
            LinuxExecutableFileNames = ["stellaris"],
            SteamAppId = "281990",
        ...
        new()
        {
            ...
            LinuxExecutableFileNames = ["bin/victoria3"],
            SteamAppId = "529340",
        ...
        new()
        {
            ...
            LinuxExecutableFileNames = ["binaries/imperator"],
            SteamAppId = "859580",
